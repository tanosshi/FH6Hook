...
GitHub Actions downloads the Microsoft Detours v4.0.1 zip and builds it automatically for release builds. Local builds still need `Detours-src` in the project folder.`.
